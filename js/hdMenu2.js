...
$(window).scroll(function(event){
	...
	if(scTop > 500){
		...
		$(".main_header .main_nav_wr > ul > li > a").css({color:"#2a2a2a"});	
		$(".main_header .ham_btn img").attr("src", "/images/icon_ham01.png");
		//$(".header .logo img").attr("src", "/images/logo_c.png");	
	} else {
		// 헤더
		$(".main_header").removeClass('on');
		$(".main_header .main_nav_wr > ul > li > a").css({color:"#fff"});
		$(".main_header .ham_btn img").attr("src", "/images/icon_ham00.png");
		//$(".header .logo img").attr("src", "/images/logo_w.png");		
	}
	...
	if(scTop > 0 ){
		...
		$(".sub_header .main_nav_wr > ul > li > a").css({color:"#2a2a2a"});	
		$(".sub_header .ham_btn img").attr("src", "/images/icon_ham01.png");
		//$(".header .logo img").attr("src", "/images/logo_c.png");	
	} else {
		// 헤더
		$(".sub_header").removeClass('on');
		$(".sub_header .main_nav_wr > ul > li > a").css({color:"#fff"});
		$(".sub_header .ham_btn img").attr("src", "/images/icon_ham00.png");
		//$(".header .logo img").attr("src", "/images/logo_w.png");		
	}
});
